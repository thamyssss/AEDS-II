...
public class Main {
    ...
    public static Scanner pesquisaArvore(ArvorePatricia dicionario, Scanner search_input) {
         // Pesquisa cada chave(contida no arquivo palavras.txt) na arvore
    ...
    public static void main (String[] args) {
        ...
        ExtraiPalavra input;
        try{
            input = new ExtraiPalavra("delimitador.txt", args[0]);
        }catch (Exception e){
